...
proNormalRes_Krij <- doSingleOmicsAnalysis(proNormal_Krij, soa_metaVar = 'Recurrence', num_sigFeats = 6,
                                           ...
                                           pca_metaVar = c('Recurrence', 'Gender', 'Age',
                                                           'Smoking', 'Stage', 'Adjuvant'))
# proNormalRes_Krij <- readRDS('./data/Discovery/potential_proteins/Combined_proNormalRes_Krij.rds')
```
...
# => Tumor P63104 abundances are not associated with pathological stages or tumor purity.
# Difference in mean abundances between Normal and Tumor samples might be larger
# if patients are at advanced cancer stage.
