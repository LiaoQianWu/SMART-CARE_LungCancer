...
stored in SummarizedExperiment objects for further analyses. </font>
...
Display dimensions of filtered data (39 samples and 648 features)
```{r}
dim(proPlasma)
```
...
Display dimensions of filtered data (40 samples and 6873 features)
```{r}
dim(proTissue)
```
