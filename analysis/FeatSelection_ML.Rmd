...
fullImpoFeatTab <- topImpoFeatPlots$fullImpoFeatTab
dplyr::filter(fullImpoFeatTab, !is.na(Cluster))

for (i in seq_len(nrow(fullImpoFeatTab))) {
  
}

impoRes <- topImpoFeatPlots$fullImpoFeatTab %>%
