...
**1LJXIN_TU**, **I0HVOL_TU**, and **7EAOX7_TU** were excluded. (Check Section
...
6 Tumor samples and 1 Normal sample have been excluded before preprocessing. Check
**Show reasons for removing samples** for more details
```{r}
# Preprocess data
...
vs Normal, PC1). Samples 'I0HVOL_TU' and '7EAOX7_TU' got decent tumor purity but
still got removed due to misclassification and similar molecular signature as normal
samples (PC1, clustering). Sample 'Q89YQK_NG' is removed due to high level of missingness
(71%) and potential outlier (PC2).
