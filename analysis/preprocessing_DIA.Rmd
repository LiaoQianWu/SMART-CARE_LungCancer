...
of interest before conducting VSN. </font>
...
Display dimensions of filtered data (34 samples and 445 features)
```{r}
dim(proPlasma)
```
...
Display dimensions of filtered data (34 samples and 5658 features)
```{r}
dim(proTissue)
```
